  ...
  Widget build(BuildContext context) {
    ...
    return new Container(
      ...
      child: new FlatButton(
        ...
        child: new Container(
          width: deviceSize.width, height: 230.0, color: Colors.white,
          child: new Column(
                  ...
                  child: new Row(
                    children: [
                          ...
                          children: [
                            InkWell(
                              ...
                              child: new Container(
                                  ...
                                  child: new Text("Premium Sports Shoes",
                      ...
                      new Padding(
                        ...
                        child: new Image.asset("lib/assets/sports shoes.png",
